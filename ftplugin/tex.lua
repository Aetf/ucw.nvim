...
-- `ftplugin/bib.lua` and `ftplugin/plaintex.lua` carry the same line for the
-- other two filetypes texlab attaches to. See docs/design/phase6-format-lint.md §1.5.
